...
export const StyleProvider = ({ children }) => {
  ...
  const styles = {
    japanese: {
      ...
      logo: 'w-16 h-16 border-2 border-black hover:border-orange-400 transition-colors duration-200',
      button: 'px-4 py-2 bg-white border-2 border-black text-black font-medium hover:bg-orange-50 hover:border-orange-400 transition-all duration-200',
      toggleButton: 'px-3 py-1 bg-black text-white font-bold hover:bg-orange-400 hover:text-black transition-all duration-200',
      background: 'bg-gray-50',
      cardContainer: 'bg-white border-2 border-black mx-8 my-8 p-8',
      cardHeader: 'bg-orange-50 border-2 border-black px-6 py-3 inline-block mb-8',
      card: 'bg-white border-2 border-black p-3 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all duration-200',
    ...
    minimal: {
      ...
      logo: 'w-12 h-12 rounded-full border border-gray-300 hover:border-gray-400 transition-colors duration-300',
    ...
    neobrutalist: {
      ...
      navContainer: 'flex pl-8 pr-8 pt-4 pb-4 items-center justify-between max-w-6xl mx-auto',
      logo: 'w-16 h-16 border-4 border-black hover:border-lime-400 transition-colors duration-200',
    ...
    cyberpunk: {
      ...
      navContainer: 'flex pl-8 pr-8 pt-4 pb-4 items-center justify-between max-w-6xl mx-auto',
      logo: 'w-16 h-16 border-2 border-cyan-400 hover:border-pink-500 hover:shadow-[0_0_20px_#00ffff] transition-all duration-200',
    ...
    glassmorphism: {
      ...
      navContainer: 'flex pl-8 pr-8 pt-6 pb-6 items-center justify-between max-w-6xl mx-auto',
      logo: 'w-14 h-14 rounded-2xl backdrop-blur-md bg-white/20 border border-white/30 hover:bg-white/30 transition-all duration-300',
